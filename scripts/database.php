...
exec("sed -i 's/DB_CONNECTION=.*/DB_CONNECTION={$_POST['database-type']}/g' ".escapeshellarg($envFile));
exec("sed -i 's/DB_HOST=.*/DB_HOST={$_POST['host']}/g' ".escapeshellarg($envFile));
exec("sed -i 's/DB_PORT=.*/DB_PORT={$_POST['port']}/g' ".escapeshellarg($envFile));
exec("sed -i 's/DB_DATABASE=.*/DB_DATABASE={$_POST['database']}/g' ".escapeshellarg($envFile));
exec("sed -i 's/DB_USERNAME=.*/DB_USERNAME={$_POST['user']}/g' ".escapeshellarg($envFile));
exec("sed -i 's/DB_PASSWORD=.*/DB_PASSWORD={$_POST['password']}/g' ".escapeshellarg($envFile));
